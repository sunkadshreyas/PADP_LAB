...
long CacheFriendlySieve(long n)
{
    long count = 0;
    long m = (long)sqrt((double)n);
    // composite[i] = 0 means number is prime and 1 means composite
    bool *composite = new bool[n + 1];
    memset(composite, 0, n);
...
int main()
{
    ...
    cin >> n;
    long count1 = CacheUnfriendlySieve(n);
    cout << count1 << endl;
    cout << "Time : " << t << endl;
    long count2 = CacheFriendlySieve(n);
    cout << count2 << endl;
    cout << "Time : " << t << endl;
    long count3 = ParallelSieve(n);
    cout << count3 << endl;
    cout << "Time : " << t << endl;
}
